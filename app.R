...
#                                              READING THE FILES
#  --------------------------------------------------------------------------------------------------------
title <- tags$img(src("logo.png"),height='50', width='46',"WQD7001")
Datafinal= read.csv("finalDS_V2.csv")
...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem(("Model"),tabName = "modelList",icon=icon('map'))
    )
  ),
  ...
  dashboardBody(
    ...
    tags$head(
      tags$style(
        HTML(" #compare_state_option,#compare_year_option ,.compare-county-wrapper { display:flex; margin-bottom:-10px;}
    				...
    				.box.box-solid.box-primary {border: 1px solid #00a65a !important;}
    				.box.box-solid.box-primary>.box-header { background: #00a65a !important; background-color: #00a65a !important; }
    ...
    tabItems(
      ...
      tabItem(tabName = "home",
              ...
              br(),
              fluidRow(
                column(width=7,tags$h2(width=5,"Beautiful City")),
                column(width=5,tags$h2(width=5,"Top News"))),

              fluidRow(
                box(width=7,HTML('<td><img src="1.jpeg" id="imagesize"><img src="2.jpeg" id="imagesize"><img src="3.jpeg" id="imagesize"><img src="4.jpeg" id="imagesize"><img src="5.jpeg" id="imagesize"><img src="6.jpeg" id="imagesize"><img src="7.jpeg" id="imagesize"><img src="8.jpeg" id="imagesize"></td>
                <td><img src="1.jpeg" id="imagesize"><img src="2.jpeg" id="imagesize"><img src="3.jpeg" id="imagesize"><img src="4.jpeg" id="imagesize"><img src="5.jpeg" id="imagesize"><img src="6.jpeg" id="imagesize"><img src="7.jpeg" id="imagesize"><img src="8.jpeg" id="imagesize"></td>
                <td><img src="1.jpeg" id="imagesize"><img src="2.jpeg" id="imagesize"><img src="3.jpeg" id="imagesize"><img src="4.jpeg" id="imagesize"><img src="5.jpeg" id="imagesize"><img src="6.jpeg" id="imagesize"><img src="7.jpeg" id="imagesize"><img src="8.jpeg" id="imagesize"></td>')),
              ...
              fluidRow(
                column(width=5,tags$img(src="aboutus.png", height=270, width="50%", hspace="90")),
              ...
              fluidRow(
                column(3,
                       box(title = "Inputs",solidHeader = TRUE, status = "primary", width =12,height=600,
                           selectInput("Cities1",h3("Choose a City"),City,selected = 'Johor'),
